 ...
 * 客户删除通知处理
 */
public class CustomerDeleteHandler implements ChannelAwareMessageListener {
	private final Logger logger = LogManager.getLogger(CustomerDeleteHandler.class);
	@Autowired
	...
	public void onMessage(Message message, Channel channel) {
		...
		try {
			...
			// 删除客户相关 OpenAPI
			openApiService.deleteByCustomer(customer.getCustomerId());
