...
public class DataServiceApi extends BaseModel implements Serializable {
    /**
     * 接口ID
     */
    @Id
     ...
     * 数据字典
     */
    @Column(name = "response_dic")
    private String responseDic;
    /**
     * 上游URL
     */
    ...
    public String getResponseDic() {
        return responseDic;
    }

    public void setResponseDic(String responseDic) {
